...
Item {
    ...
    ListModel {
        ...
        ListElement {
            item: "library"
            icon: "qrc:/images/icon_lib.png"
            page: "qrc:/qml/Library.qml"
        }
        ListElement {
            item: "download"
            icon: "qrc:/images/icon_download.png"
            page: "qrc:/qml/Downloads.qml"
        }
        ListElement {
            item: "about"
    ...
    function textItemMenu( item )
    {
        ...
        switch( item ) {
        case "joystick":
            textReturn = qsTr("Chat wheel")
            break;
        case "library":
            textReturn = qsTr("Library")
            break;
        case "download":
            textReturn = qsTr("Downloads")
            break;
        case "about":
